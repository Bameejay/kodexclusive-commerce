      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <form onSubmit={formik.handleSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                className={`w-96 px-3 py-2 border bg-gray-100 rounded-sm focus:outline-none focus:ring ${
                  formik.touched.firstName && formik.errors.firstName ? 'border-red-500' : 'focus:border-blue-300'
                }`}
            ...
            <div className="mb-4">
              <label className="block text-gray-700 text-xs font-bold mb-2" htmlFor="streetAddress">
                Street Address*
              </label>
              <input
                type="text"
                ...
                name="streetAddress"
                className={`w-96 px-3 py-2 border bg-gray-100 rounded-sm focus:outline-none focus:ring ${
                  formik.touched.streetAddress && formik.errors.streetAddress ? 'border-red-500' : 'focus:border-blue-300'
                }`}
            ...
            <div className="mb-4">
              <label className="block text-gray-700 text-xs font-bold mb-2" htmlFor="apartment">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                name="city"
                className={`w-96 px-3 py-2 border bg-gray-100 rounded-sm focus:outline-none focus:ring ${
                  formik.touched.city && formik.errors.city ? 'border-red-500' : 'focus:border-blue-300'
                }`}
            ...
            <div className="mb-4">
              ...
              <input
                ...
                name="phoneNumber"
                className={`w-96 px-3 py-2 border bg-gray-100 rounded-sm focus:outline-none focus:ring ${
                  formik.touched.phoneNumber && formik.errors.phoneNumber ? 'border-red-500' : 'focus:border-blue-300'
                }`}
            ...
            <div className="mb-4">
              <label className="block text-gray-700 font-bold mb-2 text-xs" htmlFor="emailAddress">
                Email Address*
              </label>
              <input
                type="email"
                ...
                name="emailAddress"
                className={`w-96 px-3 py-2 border bg-gray-100 rounded-sm focus:outline-none focus:ring ${
                  formik.touched.emailAddress && formik.errors.emailAddress ? 'border-red-500' : 'focus:border-blue-300'
                }`}
            ...
            <div className="mb-4">
              <label className="inline-flex items-center">
                ...
                />
                <span className="ml-2 text-gray-700 text-xs">Save this information for faster check-out next time</span>
              </label>
            </div>
          </form>
        </div>
          ...
          <div className="bg-white p-4 rounded-md shadow-md">
            {cartItems.map((item) => (
              <div key={item.id} className="flex justify-between items-center mb-4">
                ...
                <div className="text-right">
                  <span className="block">${(item.currentPrice * item.quantity).toFixed(2)}</span>
                </div>
              </div>
            ))}
            ...
            <div className="mb-4">
              ...
              <div className="flex">
                ...
                />
                <button type="button" className="bg-red-500 text-white px-4 py-2 rounded-r-md focus:outline-none">
                  Apply Coupon
                </button>
              </div>
            </div>
            <button type="submit" className="bg-red-500 text-white py-2 px-4 rounded-md w-full mt-4">
              Place Order
            </button>
            </div>
            </div>
