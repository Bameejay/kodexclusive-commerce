...
const ProductList = () => {
  ...
  return (
    <div className="container mx-auto py-4 mb-8">
      ...
      <div className="flex justify-between mt-20 bg-black p-10">
        {/* Left Side */}
        <div className="flex flex-col space-y-10">
          ...
          <div className="flex flex-row space-x-2">
            <p className="rounded-full bg-white text-center w-16 h-18 p-3 text-xs font-bold">23 <br /> hours</p>
            <p className="rounded-full bg-white text-center w-16 h-18 p-3 text-xs font-bold">O5 <br /> Days</p>
            <p className="rounded-full bg-white text-center w-16 h-18 p-3 text-xs font-bold">59 <br /> Minutes</p>
            <p className="rounded-full bg-white text-center w-16 h-18 p-3 text-xs font-bold">35 <br /> Seconds</p>
          </div>
          <div><button className="bg-[#00FF66] py-2 px-6 text-sm font-bold text-white rounded-sm">Buy Now!</button></div>
        </div>
          
          
          {/* Right Side */}
          <div className="object-contain"><img src={jblImage} alt="jbl"/></div>
      </div>
